...
%...................sine..............................
 ...
 %-------------------square wave------------------------------------
 %r=0.03*441.2*[0*ones(floor(length(t)/5),1); 1*ones(floor(length(t)/5),1); 0*ones(floor(length(t)/5),1); -1*ones(floor(length(t)/5),1); 0*ones(length(t)-4*floor(length(t)/5),1)];
  %...................................Step with various jump...................................
  %r=[1*ones(floor(length(t)/4),1); 3*ones(floor(length(t)/4),1); 5*ones(floor(length(t)/4),1);  -1*ones(length(t)-3*floor(length(t)/4),1)];
...
for i=1:length(t)-1
   ...
   %-------------------------------------------------------------------
    ...
    for j=1:P
        ...
        Y_d(j,i+1)=alpha*y+(1-alpha)*r(i+1);
        y=Y_d(j,i+1);
    end
